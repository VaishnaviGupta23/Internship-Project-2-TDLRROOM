...
<body> 
 ...
 <h2>TDL RUNNING ROOM</h2>
    ...
    <a id="tt" class="btn btn-outline-primary" href="rroom_main.php" role="button">Home</a>
     ...
     <div class="container"> 
       <h6> Please select the Bed Numbers to be Vacated</h6>
         <div class="row">
             <div class="col-sm-3"></div>
            <div class="col-sm-6 bg-light">
    <form id="xx" action="add_vac.php" method="post">
    ...
    echo "</tr>";
		$cmd="select * from room_number where status='2' or status='3' order by bed_no";
