  ...
  text-shadow: 0 1px 0 #ccc,
    ...
    <a id="tt" class="btn btn-outline-primary" href="rroom_main.php" role="button">Home</a>
       ...
       <div class="Card bg-light" style="width: 800Px; margin-left: 420Px; margin-top:30Px;" > 
           <div class="card-body">
  <h2 style="text-align:center"> Crew And Guard Call Book</h2>
...
$sql = mysqli_query($conn, "SELECT crew_id,crew_name,designation From room_number where status='1'");
...
?>
  ...
  <div class="form-group">      
      <input type="text" onfocus="(this.type='date')" class="form-control" id="from" placeholder="Enter Call Date" name="date"  required>
    </div>
      <div class="form-group">      
      <input type="text" onfocus="(this.type='time')" class="form-control" placeholder="Enter Call Time"  name="time" required>
    </div>      
     <br>
     <br>
     <br>
