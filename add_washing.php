...
if(isset($_POST['submit']))
{
    ...
    $cmd1="insert into balance (dated,bedsheet,pillow_cover,blanket,blanket_cover,net,curtain,towel,sofa_cover) values ('$dated','$t1','$t2','$t3','$t4','$t5','$t6','$t7','$t8')";
    require_once("dbcon.php");
    $res1=mysqli_query($conn,$cmd1);
    
    
    $cmd="insert into issued (dated,bedsheet,pillow_cover,blanket,blanket_cover,net,curtain,towel,sofa_cover) values ('$dated','$add_bedsheet','$add_pillow_cover','$add_blanket','$add_blanket_cover','$add_net','$add_curtain','$add_towel','$add_sofa_cover')";
    require_once("dbcon.php");
    $res=mysqli_query($conn,$cmd);
    $cmd2="insert into receive (dated,bedsheet,pillow_cover,blanket,blanket_cover,net,curtain,towel,sofa_cover) values ('$dated','$less_bedsheet','$less_pillow_cover','$less_blanket','$less_blanket_cover','$less_net','$less_curtain','$less_towel','$less_sofa_cover')";
    require_once("dbcon.php");
    $res2=mysqli_query($conn,$cmd2);
    if($res2)
	{
		echo ("<div class='container my-3'><div class='alert alert-success'><strong>Success : </strong>Data Saved successfully.</div></div>");
	}
	else
	{
