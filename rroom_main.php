    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="current_occp.php">Current Occupancy</a>
          <a class="dropdown-item" href="date_picker_ghi.php">Reports GHI</a>
          <a class="dropdown-item" href="dp_ghi_marks.php">Marks Wise GHI</a>
          <a class="dropdown-item" href="dp_m_position.php">Morning Position</a>
          <a class="dropdown-item" href="dp_m_positiondate.php">Date Wise Occupancy(clock Wise)</a>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a id="zz2" class="nav-link" href="vacation.php">Vacation</a>
      </li>
        <li class="nav-item">
        <a id="zz1" class="nav-link" href="edit_lp.php">Edit LP Data</a>
      </li>
         
        <li class="nav-item">
        <a id="zz2" class="nav-link" href="excel_export.php">Back Up</a>
      </li>
    </ul>
 ...
 echo "</table>";
   ...
   while($rec=mysqli_fetch_assoc($res)){
       ...
       $status=$rec['status'];
        $t1=date('Y-m-d H:i');
       $t2=strtotime($t1);
       $t3=($occupation_date.''.$occupation_time);
      
      $t4=strtotime($t3);
    $t5=($t2-$t4);
       
    $t6=round(abs($t2-$t4) / 3600);
    $t7=round(abs($t2-$t4) / 60). "Minutes";
     $t8=$t6*60;
       $t9=($t7-$t8);
       $t10=$t6.'Hrs'.$t9.'Min';
