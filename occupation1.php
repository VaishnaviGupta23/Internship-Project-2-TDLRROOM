...
<div class="container col-sm-6">
  ...
  <?php
        ...
        if($status==0 and $floor_no=='1' and $bed_serial=='A' and $wing=='1' )
          ...
          echo "<td><a href='crew_booking.php?crew_id=$crew_id & crew_name=$crew_name & designation=$designation & traction=$traction & mobile=$mobile & hq=$hq &crew_id=$crew_id & crew_name=$crew_name & designation=$designation & traction=$traction & mobile=$mobile & hq=$hq  & wkg_type=$wkg_type & train=$train & loco=$loco &bed=101B'><img src='images/GREEN1.JPG' alt='Green image' style='height:20px text-align:centre'></a></td>";   
